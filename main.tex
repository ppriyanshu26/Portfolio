...
\hspace{1.5em}
\begin{flushleft}
  \textbf{Languages:} Python, Java, Dart \\[6pt]
  \textbf{Web:} HTML, CSS, Flask \\[6pt]
  \textbf{Database:} MySQL, OracleDB \\[6pt]
  \textbf{Tools/Frameworks:} Android, Flutter, NLP, Git/GitHub, AWS, NIST
\end{flushleft}
...
\begin{itemize}
  ...
  \item Secured A grade in Cyber Security Analyst Course on IBM-Adroit platform.
